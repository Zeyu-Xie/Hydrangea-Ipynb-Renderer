...
app = BUNDLE(
    coll,
    name='Jupyrender.app',
    icon='./src/icon/icon_1024.png',
    bundle_identifier="com.zeyu-xie.hydrangea-jupyrender",
    info_plist={
        'CFBundleName': 'Jupyrender',
        'CFBundleExecutable': 'main',
        'CFBundleIdentifier': 'com.example.hydrangea-jupyrender',
